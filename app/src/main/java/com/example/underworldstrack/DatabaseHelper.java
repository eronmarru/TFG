...
/**
 * Clase ayudante para gestionar la base de datos SQLite de la aplicación.
 * Maneja la creación, actualización y operaciones CRUD para Bandas, Cartas, Mazos, etc.
 */
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String COLUMN_FIGHTER_IMAGE = "image"; 
    ...
    // Tabla de Mazos Rivales (Preconstruidos)
    ...
    public static final String COLUMN_RIVAL_DECK_BAND_ID = "band_id"; 
    public static final String COLUMN_RIVAL_DECK_TYPE = "type"; 
    public static final String COLUMN_RIVAL_DECK_SPECIAL_RULES = "special_rules"; 
    ...
    public static final String COLUMN_CARD_SUBTYPE = "subtype"; 
    ...
    public static final String COLUMN_CARD_GLORY = "glory_points"; 
    public static final String COLUMN_CARD_EFFECT = "effect"; 
    public static final String COLUMN_CARD_COST_RESTRICTION = "cost_restriction"; 
    public static final String COLUMN_CARD_IMAGE = "image"; 

    // Tabla de Mazos de Usuario
    ...
    public static final String COLUMN_USER_DECK_BAND_ID = "band_id"; 
    public static final String COLUMN_USER_DECK_RIVAL_1 = "rival_deck_1_id";
    public static final String COLUMN_USER_DECK_RIVAL_2 = "rival_deck_2_id"; 

    // Tabla de Contenido de Mazos de Usuario (Relación Mazo-Carta)
    ...
    // SQL para crear tabla de luchadores
    ...
    /**
     * Crea las tablas de la base de datos e inserta los datos iniciales.
     */
    @Override
    public void onCreate(SQLiteDatabase db) {
        ...
        // Insertar datos iniciales (Bandas, Mazos, Cartas)
        insertInitialData(db);
    }

    /**
     * Maneja la actualización de la versión de la base de datos.
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_USER_DECK_CONTENT); 
    ...
    private void insertInitialData(SQLiteDatabase db) {
        ...
        insertFighterInternal(db, (int)mollogBandId, "Stalagsquig", "mollogs_mob_4"); 
        ...
        long ephilimBandId = insertBandInternal(db, "Ephilim's Pandaemonium",
                ...
                "Disciples of Tzeentch", "ephilims_pandaemonium_0"); 
