...
/**
 * Activity que muestra la lista de mazos creados por el usuario.
 */
public class UserDecksActivity extends AppCompatActivity {
    ...
    /**
     * Carga los mazos del usuario desde la base de datos y actualiza el RecyclerView.
     */
    ...
    /**
     * Recarga la lista cuando la actividad se reanuda (por si hubo cambios).
     */
    @Override
