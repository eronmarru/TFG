...
/**
 * Activity que muestra los detalles de un mazo de usuario específico.
 * Muestra las cartas contenidas en el mazo y permite eliminar el mazo.
 */
public class UserDeckDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Configurar botón de eliminar con diálogo de confirmación
        btnDeleteDeck.setOnClickListener(v -> confirmDeleteDeck());
    }

    /**
     * Muestra un diálogo de confirmación antes de eliminar el mazo.
     */
    ...
    /**
     * Carga las cartas asociadas al mazo desde la base de datos.
     */
    private void loadCards() {
        List<Card> cards = dbHelper.getCardsForUserDeck(userDeckId);
        CardAdapter adapter = new CardAdapter(cards, null);
        adapter.setReadOnly(true); // Solo lectura, no se pueden seleccionar cartas aquí
