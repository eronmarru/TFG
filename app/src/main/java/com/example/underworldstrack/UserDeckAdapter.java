...
/**
 * Adaptador para mostrar la lista de Mazos creados por el Usuario.
 * Permite navegar al detalle de un mazo al hacer clic.
 */
public class UserDeckAdapter extends RecyclerView.Adapter<UserDeckAdapter.UserDeckViewHolder> {

    private List<UserDeck> userDecks; // Lista de mazos de usuario
    private Context context;
    private DatabaseHelper dbHelper; // Referencia a base de datos (no usada directamente aquí, pero disponible)
    ...
    public void onBindViewHolder(@NonNull UserDeckViewHolder holder, int position) {
        ...
        // Navegar a UserDeckDetailActivity al hacer clic en el mazo
