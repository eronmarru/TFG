...
/**
 * Activity para el lanzamiento de dados.
 * Permite seleccionar tipo de dados (ataque/defensa) y cantidad.
 * Incluye funcionalidad de agitar el dispositivo (shake) para lanzar.
 */
public class DiceRollerActivity extends AppCompatActivity implements SensorEventListener {
    ...
    // Variables para el sensor de acelerómetro (agitar)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Listener para la barra de cantidad de dados
    ...
    /**
     * Detecta movimiento del dispositivo para la función de agitar.
     */
    @Override
    ...
    /**
     * Realiza el lanzamiento de dados y muestra los resultados.
     */
    private void rollDice() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            // Preservar estado anterior si el tipo de dado no ha cambiado
    ...
    /**
     * Crea una vista de imagen para un dado individual.
     */
    ...
    /**
     * Asigna una cara aleatoria al dado según si es de ataque o defensa.
     */
    private int setRandomFace(ImageView dice, boolean isAttack, Integer previousResId, Float previousRotation) {
        ...
        // Si sale la misma cara, rota el dado para dar efecto visual de cambio
