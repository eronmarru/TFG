...
/**
 * Activity que muestra la lista de bandas pertenecientes a una facción específica (ej. Caos).
 */
public class FactionBandsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Obtener la facción seleccionada del Intent
        ...
        // Cargar bandas de la base de datos
        ...
        // Configurar adaptador con callback para clics
    ...
    /**
     * Muestra una notificación local cuando se selecciona una banda.
     * @param band La banda seleccionada
     */
    ...
    /**
     * Navega a la pantalla de detalles de la banda.
     */
