...
public class BandDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Agrupar imágenes en objetos Fighter (base + inspirada)
        List<Fighter> fighters = new ArrayList<>();
        for (Integer imgId : fighterImages) {
            try {
                String entryName = getResources().getResourceEntryName(imgId);
                // Si la imagen ya es una versión inspirada, la ignoramos para evitar duplicados
                // (asumiendo que la versión base también está en la lista y se procesará)
    ...
    private void showExpandedImage(int imageResId) {
        ...
        // Al volver a pulsar la imagen ampliada, se cierra (vuelve a tamaño original)
    ...
    private class FighterImageAdapter extends RecyclerView.Adapter<FighterImageAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            // Configurar click para alternar
